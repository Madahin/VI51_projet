...
/**
 * The Class BasePosition is a representation of a base for the purpose of being used by a GUI.
 */
public class BasePosition extends Position {
	 ...
	 *
	 * @param c the circle graphically representing the base
	 */
	 ...
	 * @param _y the position of the base in y
	 */
